...
(function (factory) {
  ...
  var dialog = renderer.create('<div class="modal modal-inner" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
      $node.addClass('fade');
    }
    $node.html([
      ...
      '      <button type="button" class="close" onClick="hideThisModel()" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
