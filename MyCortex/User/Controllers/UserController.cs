...
namespace MyCortex.User.Controller
{
    ...
    public class UserController : ApiController
    {
      ...
      //  [CheckSessionOutFilter]
        ...
        [HttpGet]
        //  [CheckSessionOutFilter]
        public HttpResponseMessage PatientHealthDataDetails_List(long Patient_Id, int OptionType_Id, long Group_Id, int StartRowNumber,int EndRowNumber,int Active, Guid Login_Session_Id, long UnitsGroupType = 1)
        {
      ...
      //  [CheckSessionOutFilter]
        ...
        public IList<Patient_OtherDataModel> Patient_OtherData_List(long Patient_Id, int IsActive,Guid Login_Session_Id)
        {
            ...
            try
            {
                if (_logger.IsInfoEnabled)
                    _logger.Info("Controller");
                model = repository.Patient_OtherData_List(Patient_Id, IsActive,Login_Session_Id);
                return model;
            }
            catch (Exception ex)
            {
