...
namespace MyCortex.Admin.Models
{
    public class ProtocolModel
    {
        ...
        public long? Comp_Parameter_Id { get; set; }
    ...
    public class Diag_ProtocolModel
    {
        public long Id { get; set; }
        public long? Protocol_Id { get; set; }
        public string ProtocolName { get; set; }
    ...
    public class Comp_ProtocolModel
    {
        public long Id { get; set; }
        public long Parameter_Id { get; set; }
        public string ParameterName { get; set; }
        ...
        public int Isactive { get; set; }
        public long Created_By { get; set; }
        public bool occur_inter { get; set; }
        public int occur_inter_val { get; set; }
        public IList<MonitorDateTime> duration_list { get; set; }
        public DateTime starttime { get; set; }
        public DateTime endtime { get; set; }
        public string selectedDays { get; set; }
    }

    public class MonitorDateTime
    {
        public long? id { get; set; }
