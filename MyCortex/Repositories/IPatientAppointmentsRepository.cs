...
namespace MyCortex.Repositories
{
    interface IPatientAppointmentsRepository
    {
        ...
        IList<PatientAppointmentsModel> DepartmentwiseDoctorList(string DepartmentIds, long InstitutionId, DateTime Date,Int32 IsShift,Int32 Language_Id);
        IList<AppointmentReasonType> AppointmentReasonType_List(long Institution_Id, Int32 Language_Id);
        ...
        IList<DoctorAppointmentTimeSlotModel> GetAppointmentDoctorDetails(string DoctorIds, DateTime Date, DateTime EndDate, Guid Login_Session_Id, long TimeZoneId, long Institution_Id);
