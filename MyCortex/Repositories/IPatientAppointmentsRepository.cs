...
namespace MyCortex.Repositories
{
    interface IPatientAppointmentsRepository
    {
        ...
        IList<DoctorAppointmentTimeSlotModel> GetAppointmentDoctorDetails(long DoctorId, DateTime Date, DateTime EndDate, Guid Login_Session_Id, long TimeZoneId, long Institution_Id);
