...
namespace MyCortex.Repositories
{
    interface IPatientReportDetailsRepositoy
    {
        ...
        IList<AutomatedTestReportDetails> AutomatedTestReport_InsertUpdate(long TEST_ID, DateTime TEST_START_DTTM, DateTime TEST_END_DTTM, bool TEST_RESULT, string TEST_RESULT_REASON, string TEST_REPORT, string TEST_SESSION = "", string TEST_REF = "");
        AutomatedTestReportDetails AutomatedTestReport_View(long TEST_ID);
    }
}